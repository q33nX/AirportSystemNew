...
public class MockDataService : IFlightRepository
{
    ...
    private void GenerateData()
    {
        ...
        new Airport { Code = "SVO", Name = "Шереметьево", City = citiesList[0], TimezoneOffset = 3 },
        new Airport { Code = "LHR", Name = "Хитроу", City = citiesList[1], TimezoneOffset = 0 },
        new Airport { Code = "IST", Name = "Стамбул Новый", City = citiesList[2], TimezoneOffset = 3 },
        new Airport { Code = "DXB", Name = "Дубай Интернешнл", City = citiesList[3], TimezoneOffset = 4 },
        new Airport { Code = "CDG", Name = "Шарль-де-Голль", City = citiesList[4], TimezoneOffset = 1 },
        new Airport { Code = "HND", Name = "Ханеда", City = citiesList[5], TimezoneOffset = 9 },
        new Airport { Code = "JFK", Name = "Джон Кеннеди", City = citiesList[6], TimezoneOffset = -5 },
        new Airport { Code = "BER", Name = "Бранденбург", City = citiesList[7], TimezoneOffset = 1 },
        new Airport { Code = "FCO", Name = "Фьюмичино", City = citiesList[8], TimezoneOffset = 1 },
        new Airport { Code = "MAD", Name = "Барахас", City = citiesList[9], TimezoneOffset = 1 },
        new Airport { Code = "NQZ", Name = "Нурсултан Назарбаев", City = citiesList[10], TimezoneOffset = 5 },
        new Airport { Code = "BKK", Name = "Суварнабхуми", City = citiesList[11], TimezoneOffset = 7 }
    };
        ...
        for (int r = 1; r <= 25; r++)
        {
            ...
            foreach (char l in "ABCDEF")
                airbusA320.Seats.Add(new Seat { Row = r, Letter = l, Class = sClass });
        }
        ...
        for (int r = 1; r <= 45; r++)
        {
            ...
            foreach (char l in "ABCDEF")
                boeing777.Seats.Add(new Seat { Row = r, Letter = l, Class = sClass });
        }

        // -- Boeing 737 (Только Эконом)
